...
public class Main {
    public static void main(String[] args) {
        ...
        RealMatrix matrixC = matrixOps.addMatrices(matrixA, matrixB);
        RealMatrix matrixD = matrixOps.multiplyMatrixByScalar(matrixC, 0.5);

        // Create a vector and perform operations
        RealVector vector = new ArrayRealVector(new double[] {1, 2, 3});
        RealVector scaledVector = vectorOps.scaleVector(vector, 2.0);
        RealVector addedVector = vectorOps.addVectors(vector, scaledVector);
